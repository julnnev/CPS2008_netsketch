...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "/opt/homebrew/bin/git" rev-parse "${ref}"
...
execute_process(
  COMMAND "/opt/homebrew/bin/git" show-ref "5.0"
  WORKING_DIRECTORY "/Users/juliannevella/Desktop/CPS2008/netsketch/cmake-build-debug/_deps/raylib-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/juliannevella/Desktop/CPS2008/netsketch/cmake-build-debug/_deps/raylib-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/juliannevella/Desktop/CPS2008/netsketch/cmake-build-debug/_deps/raylib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
